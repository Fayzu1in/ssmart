...
class Product(models.Model):
    ...
    image1 = models.ImageField('picture-1', upload_to='api/media/products')
    image2 = models.ImageField('picture-2', upload_to='api/media/products', blank=True, null=True)
...
class Partners(models.Model):
    name = models.CharField(max_length=255)
    image = models.ImageField('picture', upload_to='api/media/products')
