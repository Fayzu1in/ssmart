		...
		<>
			<section className="details">
				...
				<div className="details-bottom">
					<div className="details-bottom-item">Телевизор Ssmart</div>
				...
				<div className="details-text">
					...
					<div className="details-warning">
						...
						отрывных купонах и активирует гарантию на сайте ssmart.uz. Сохраните
						кассовый чек, выданный продавцом, для подтверждения фактической даты
						покупки и просите активировать гарантию на сайте ssmart.uz после
						покупки.
					</div>
				</div>
			</section>
